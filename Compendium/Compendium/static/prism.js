...
Prism.languages.compendium = {principle: [{pattern: /#p([\S\s]*?)p#/g}], aphorism: [{pattern: /#a([\S\s]*?)a#/g}], decision: [{pattern: /#d([\S\s]*?)d#/g}], idea: [{pattern: /#i([\S\s]*?)i#/g}], observation: [{pattern: /#o([\S\s]*?)o#/g}], lesson: [{pattern: /#l([\S\s]*?)l#/g}]};
//{pattern:/#p(.*?)#/p}};
